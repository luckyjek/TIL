<!--
반복문대신 재귀호출을 사용할 때는 ?
코드가 간결하고, 이해하기 쉬워지기때문이다.
프로그램 작성 완료 후, 속도가 개선 되어야 할 부분을 골라서
따로 성능 향상을 지키는 방식으로 처리한다.

반복문은 while문이나 for문의 사용을 통해 익숙하지만,
재귀함수는 비슷한 기능임에도 조금 낯설다.

factorial -> 5팩토리얼 -> 5x4x3x2x1 =120결과를 얻는다.
-->
